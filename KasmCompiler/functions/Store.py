...
class Store(base_function):
    ...
    def __call__(self, line, registers, addresses, values, devices):
        ...
        binary_instruction = (
            "011" + reg_a.binary_value[0] + address.binary_value + reg_a.binary_value[1:]
        )
        logging.debug(f"Store instruction: {binary_instruction}")
